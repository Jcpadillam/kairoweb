export const translations = {
  ES: {
      ...
      items: [
        {
          ...
          desc: 'Optimizamos tu tienda en Shopify con motores de personalización y búsqueda inteligente.',
          tag: '+35% Tasa de Conversión'
        },
        {
          title: 'Ecosistemas CMS con IA',
          desc: 'Potenciamos Strapi y WordPress con flujos de generación de contenido y SEO automatizado.',
          tag: 'SEO Automatizado'
        },
        {
          title: 'Desarrollo Web a la Medida',
          desc: 'Construimos aplicaciones web de alto rendimiento con lógica de negocio potenciada por IA.',
          tag: 'Arquitectura Escalable'
        },
        {
          title: 'Estrategia de Datos e IA',
          desc: 'Analizamos tus datos para integrar soluciones que optimizan procesos y maximizan la rentabilidad.',
          tag: 'ROI Garantizado'
        }
      ]
    },
    targetAudience: {
      ...
      title: '¿Tu negocio está',
      titleHighlight: 'estancado',
      titleSuffix: 'por estos retos técnicos?',
      subtitle: 'Nueve de cada diez empresas LATAM pierden oportunidades por infraestructuras obsoletas. No seas una de ellas.',
      cards: [
        {
          title: 'Idea Sin Ejecución',
          desc: 'Pierdes tiempo y dinero intentando descifrar la tecnología solo. Nosotros materializamos tu visión con arquitectura escalable.'
        },
        {
          title: 'Fuga de Clientes',
          desc: 'Un sitio lento cuesta ventas reales cada segundo. Optimizamos tu Core Web Vitals para una experiencia instantánea.'
        },
        {
          title: 'Silos de Datos',
          desc: 'El trabajo manual mata la productividad. Automatizamos flujos entre tu web, CRM y ERP para que tu equipo se enfoque en vender.'
        },
        {
          title: 'Abandono Técnico',
          desc: '¿Tu programador anterior desapareció? Ofrecemos soporte 24/7 y garantía de código para que nunca te sientas solo.'
        }
      ],
      ...
      projects: [
        {
          ...
          category: 'E-commerce',
          desc: 'E-commerce desarrollado con Shopify para marca de ropa local con más de 500 productos y optimización de conversión.'
        },
        {
          title: 'Web App - Salud',
          category: 'Custom Web App',
          desc: 'Aplicación web para gestión de citas médicas con sistema de pagos y panel administrativo impulsado por datos.'
        },
        {
          title: 'Sitio Corporativo',
          category: 'Enterprise CMS',
          desc: 'Web corporativa con CMS (Strapi), blog integrado y sistema de contacto avanzado para generación de leads.'
        }
      ]
    },
    leadMagnet: {
    ...
    humanFactor: {
      badge: 'Factor Humano',
      title: 'Ingeniería de Autor para negocios en',
      titleHighlight: 'escalada',
      desc: 'Kairo nace con una misión clara: cerrar la brecha entre la ambición de negocio y la ejecución técnica de élite. Fundada bajo una filosofía de ingeniería rigurosa, nuestra estructura está diseñada para crecer junto a tu proyecto, asegurando que cada línea de código sea un activo estratégico.',
      cardTitle: 'Arquitectura de Élite',
      cardSubtitle: 'Liderando la visión técnica de Kairo'
    },
    standardOfWork: {
      badge: 'Nuestra Identidad',
      title: 'Construyendo el futuro',
      titleHighlight: 'con propósito',
      desc: 'En Kairo, combinamos innovación tecnológica con acompañamiento humano para generar valor real y confianza.'
    },
    history: {
      title: "Historia de Kairo",
      desc: "Nacimos en Barranquilla con la convicción de que la tecnología debe ser una aliada para los negocios.",
      badge: "Nuestro Origen"
    },
    mission: {
      title: "Misión",
      desc: "Impulsamos a las empresas de Colombia a crecer con soluciones tecnológicas acessibles y confiables.",
      badge: "Propósito"
    },
    vision: {
      title: "Visión",
      desc: "Ser el socio estratégico líder en transformación digital en Latinoamérica.",
      badge: "Destino"
    },
    cta: {
    ...
    trustSignals: {
      metrics: [
        { value: '+20', label: 'Sistemas Liderados', sublabel: 'En industrias críticas' },
        { value: 'Alta', label: 'Disponibilidad', sublabel: 'Sistemas de alta escala' },
        { value: 'Hosting', label: 'Estratégico', sublabel: 'Conocemos lo que necesitas' },
        { value: 'Estándares', label: 'de Élite', sublabel: 'Garantía de calidad' }
      ],
      techStackTitle: 'Stack Tecnológico & Ecosistema CMS'
    },
    footer: {
      description: 'Transformamos ideas en soluciones digitales excepcionales. Desarrollo web profesional con tecnologías de vanguardia.',
      services: {
        title: 'Servicios',
        items: ['Desarrollo Web', 'E-commerce', 'Optimización', 'Soporte Técnico']
      },
      company: {
        title: 'Empresa',
        items: ['Nuestro Proceso', 'Proyectos', 'Clientes', 'Contacto']
      },
      contact: 'Contacto',
      rights: '© 2025 Kairo. Todos los derechos reservados.',
      privacy: 'Política de Privacidad',
      terms: 'Términos de Servicio'
    },
    ourApproach: {
      badge: 'Metodología Ágil',
      titleLine1: 'Más que código, entregamos',
      titleLine2: 'resultados de negocio.',
      subtitle: 'Nuestro proceso está diseñado para minimizar riesgos y maximizar el retorno de tu inversión tecnológica.',
      steps: [
        {
          title: 'Estrategia de Crecimiento',
          desc: 'Aliamos tu visión de negocio con la tecnología correcta. No solo programamos, diseñamos el camino al éxito.',
          tag: 'ROI Enfocado'
        },
        {
          title: 'Ingeniería Escalable',
          desc: 'Construimos con estándares de Amazon y Google. Código limpio, tiempos de carga mínimos y seguridad blindada.',
          tag: 'Alto Rendimiento'
        },
        {
          title: 'Garantía de Continuidad',
          desc: 'Servidores premium y soporte prioritario. Tu web no es un gasto, es un activo que cuidamos 24/7.',
          tag: 'Soporte 24/7'
        }
      ]
    }
  ...
  EN: {
    ...
    services: {
      ...
      title: 'We propel your business with AI Engineering.',
      subtitle: 'We don\'t just build software; we create strategic assets that use AI to automate growth and maximize profitability.',
      techStackLabel: 'Tech Hub',
      items: [
        {
          title: 'High-Impact E-commerce',
          desc: 'We optimize your Shopify store with personalization engines and smart search.',
          tag: '+35% Conversion Rate'
        },
        {
          title: 'CMS Ecosystems with AI',
          desc: 'We power Strapi and WordPress with content generation workflows and automated SEO.',
          tag: 'Automated SEO'
        },
        {
          title: 'Custom Web Development',
          desc: 'We build high-performance web applications with AI-powered business logic.',
          tag: 'Scalable Architecture'
        },
        {
          title: 'Data and AI Strategy',
          desc: 'We analyze your data to integrate solutions that optimize processes and maximize ROI.',
          tag: 'Guaranteed ROI'
        }
      ]
    },
    targetAudience: {
      ...
      titleHighlight: 'stuck',
      titleSuffix: 'due to these technical challenges?',
      subtitle: 'Nine out of ten LATAM companies lose opportunities due to obsolete infrastructure. Don\'t be one of them.',
      cards: [
        {
          title: 'Idea Without Execution',
          desc: 'You lose time and money trying to figure out tech alone. We materialize your vision with scalable architecture.'
        },
        {
          title: 'Customer Churn',
          desc: 'A slow site costs real sales every second. We optimize your Core Web Vitals for an instant experience.'
        },
        {
          title: 'Data Silos',
          desc: 'Manual work kills productivity. We automate flows between your web, CRM, and ERP so your team focuses on selling.'
        },
        {
          title: 'Technical Abandonment',
          desc: 'Did your previous developer disappear? We offer 24/7 support and code guarantee so you never feel alone.'
        }
      ],
      trustedBy: 'Trusted by leaders in:',
      trustedSectors: ['Fintech', 'Ecommerce', 'Logistics', 'SaaS'],
      ctaBox: {
        title: 'Stop accumulating technical debt',
        title2: 'and start to',
        titleHighlight: 'really scale',
        desc: 'We analyze your case at no cost and deliver a value proposal in less than 24 hours.',
        button: 'Request my Free Audit',
        note1: 'Response in less than 24h',
        note2: 'No commitment • 100% Confidential'
      }
    },
    process: {
      ...
      projects: [
        {
          ...
          category: 'E-commerce',
          desc: 'E-commerce developed with Shopify for local clothing brand with 500+ products and conversion optimization.'
        },
        {
          title: 'Health Web App',
          category: 'Custom Web App',
          desc: 'Web application for medical appointment management with payment system and data-driven admin dashboard.'
        },
        {
          title: 'Corporate Site',
          category: 'Enterprise CMS',
          desc: 'Corporate web with CMS (Strapi), integrated blog, and advanced contact system for lead generation.'
        }
      ]
    },
    leadMagnet: {
    ...
    miniCloser: {
      badge: 'Roadmap 2025',
      badge2: 'Guide for Executives',
      title: 'Ready to build the',
      title2: 'next level of your business?',
      desc: 'Let\'s talk about your technical goals. We deliver an execution roadmap with no initial cost.',
      button: 'Book Consulting',
      note: 'Response today',
      availability: 'Limited spots per month'
    },
    humanFactor: {
      badge: 'Human Factor',
      title: 'Author Engineering for businesses in',
      titleHighlight: 'scaling',
      desc: 'Kairo was born with a clear mission: to bridge the gap between business ambition and elite technical execution. Founded under a philosophy of rigorous engineering, our structure is designed to grow with your project, ensuring that every line of code is a strategic asset.',
      cardTitle: 'Elite Architecture',
      cardSubtitle: 'Leading Kairo\'s technical vision'
    },
    standardOfWork: {
      badge: 'Our Identity',
      title: 'Building the future',
      titleHighlight: 'with purpose',
      desc: 'At Kairo, we combine technological innovation with human support to generate real value and trust.'
    },
    history: {
      title: "Kairo's Story",
      desc: "Born in Barranquilla with the conviction that technology should be a business ally.",
      badge: "Our Origin"
    },
    mission: {
      title: "Mission",
      desc: "We empower Colombian companies to grow with accessible and reliable tech solutions.",
      badge: "Purpose"
    },
    vision: {
      title: "Vision",
      desc: "To be the leading strategic partner in digital transformation in Latin America.",
      badge: "Destiny"
    },
    cta: {
    ...
    trustSignals: {
      metrics: [
        { value: '+20', label: 'Systems Led', sublabel: 'In critical industries' },
        { value: 'High', label: 'Availability', sublabel: 'High-scale systems' },
        { value: 'Strategic', label: 'Hosting', sublabel: 'We know what you need' },
        { value: 'Elite', label: 'Standards', sublabel: 'Quality guarantee' }
      ],
      techStackTitle: 'Tech Stack & CMS Ecosystem'
    },
    footer: {
      description: 'We transform ideas into exceptional digital solutions. Professional web development with cutting-edge technologies.',
      services: {
        title: 'Services',
        items: ['Web Development', 'E-commerce', 'Optimization', 'Technical Support']
      },
      company: {
        title: 'Company',
        items: ['Our Process', 'Projects', 'Clients', 'Contact']
      },
      contact: 'Contact',
      rights: '© 2025 Kairo. All rights reserved.',
      privacy: 'Privacy Policy',
      terms: 'Terms of Service'
    },
    ourApproach: {
      badge: 'Agile Methodology',
      titleLine1: 'More than code, we deliver',
      titleLine2: 'business results.',
      subtitle: 'Our process is designed to minimize risk and maximize the return on your technology investment.',
      steps: [
        {
          title: 'Growth Strategy',
          desc: 'We align your business vision with the right technology. We don\'t just code, we design the path to success.',
          tag: 'ROI Focused'
        },
        {
          title: 'Scalable Engineering',
          desc: 'Built with Amazon and Google standards. Clean code, minimal load times, and bulletproof security.',
          tag: 'High Performance'
        },
        {
          title: 'Continuity Guarantee',
          desc: 'Premium servers and priority support. Your web is not an expense, it is an asset we care for 24/7.',
          tag: '24/7 Support'
        }
      ]
    }
  ...
  PT: {
    ...
    services: {
      ...
      title: 'Impulsionamos seu negócio com Engenharia de IA.',
      subtitle: 'Não apenas construímos software; criamos ativos estratégicos que usam IA para automatizar o crescimento e maximizar a rentabilidade.',
      techStackLabel: 'Hub Tecnológico',
      items: [
        {
          title: 'E-commerce de Alto Impacto',
          desc: 'Otimizamos a sua loja Shopify com motores de personalização e busca inteligente.',
          tag: '+35% Taxa de Conversão'
        },
        {
          title: 'Ecossistemas CMS com IA',
          desc: 'Potencializamos Strapi e WordPress com fluxos de geração de conteúdo e SEO automatizado.',
          tag: 'SEO Automatizado'
        },
        {
          title: 'Desenvolvimento Web Sob Medida',
          desc: 'Construímos aplicações web de alto desempenho com lógica de negócios impulsionada por IA.',
          tag: 'Arquitetura Escalável'
        },
        {
          title: 'Estratégia de Dados e IA',
          desc: 'Analisamos seus dados para integrar soluções que otimizam processos e maximizam a rentabilidade.',
          tag: 'ROI Garantido'
        }
      ]
    },
    targetAudience: {
      ...
      title: 'O seu negócio está',
      titleHighlight: 'estagnado',
      titleSuffix: 'por estes desafios técnicos?',
      subtitle: 'Nove em cada dez empresas na LATAM perdem oportunidades devido a infraestruturas obsoletas. Não seja uma delas.',
      cards: [
        {
          title: 'Ideia Sem Execução',
          desc: 'Você perde tempo e dinheiro tentando decifrar a tecnologia sozinho. Materializamos sua visão com arquitetura escalável.'
        },
        {
          title: 'Perda de Clientes',
          desc: 'Um site lento custa vendas reais a cada segundo. Otimizamos seu Core Web Vitals para uma experiência instantânea.'
        },
        {
          title: 'Silos de Dados',
          desc: 'O trabalho manual mata a produtividade. Automatizamos fluxos entre seu site, CRM e ERP para que sua equipe foque em vender.'
        },
        {
          title: 'Abandono Técnico',
          desc: 'Seu programador anterior desapareceu? Oferecemos suporte 24/7 e garantia de código para que você nunca se sinta sozinho.'
        }
      ],
      trustedBy: 'Confiado por líderes em:',
      trustedSectors: ['Fintech', 'Ecommerce', 'Logística', 'SaaS'],
      ctaBox: {
        title: 'Pare de acumular dívida técnica',
        title2: 'e comece a',
        titleHighlight: 'escalar de verdade',
        desc: 'Analisamos seu caso sem custo e entregamos uma proposta de valor em menos de 24 horas.',
        button: 'Solicitar minha Auditoria Grátis',
        note1: 'Resposta em menos de 24h',
        note2: 'Sem compromisso • 100% Confidencial'
      }
    },
    process: {
      ...
      projects: [
        {
          ...
          category: 'E-commerce',
          desc: 'E-commerce desenvolvido com Shopify para marca de roupas local com mais de 500 produtos e otimização de conversão.'
        },
        {
          title: 'Web App - Saúde',
          category: 'Custom Web App',
          desc: 'Aplicação web para gestão de consultas médicas com sistema de pagamentos e painel administrativo impulsionado por dados.'
        },
        {
          title: 'Site Corporativo',
          category: 'Enterprise CMS',
          desc: 'Web corporativa com CMS (Strapi), blog integrado e sistema de contato avançado para geração de leads.'
        }
      ]
    },
    leadMagnet: {
      badge: 'Recurso Gratuito',
      title: 'Domine a IA na sua empresa',
      title2: 'antes da sua concorrência.',
      desc: 'Baixe nosso guia exclusivo: "Roadmap de Transformação Digital 2025". Analisamos os 5 erros fatais que estão custando milhões às empresas LATAM.',
      placeholder: 'Seu email principal',
      button: 'Obter Guia Grátis',
      spam: '* Não enviamos spam. Apenas valor técnico puro.'
    },
    miniCloser: {
      badge: 'Roadmap 2025',
      badge2: 'Guia para Executivos',
      title: 'Pronto para construir o',
      title2: 'próximo nível do seu negócio?',
      desc: 'Vamos falar sobre seus objetivos técnicos. Entregamos um roadmap de execução sem custo inicial.',
      button: 'Agendar Consultoria',
      note: 'Resposta hoje mesmo',
      availability: 'Vagas limitadas por mês'
    },
    humanFactor: {
      badge: 'Fator Humano',
      title: 'Engenharia de Autor para negócios em',
      titleHighlight: 'escala',
      desc: 'A Kairo nasce com uma missão clara: fechar a lacuna entre a ambição de negócios e a execução técnica de elite. Fundada sob uma filosofia de engenharia rigorosa, nossa estrutura é projetada para crescer junto com seu projeto, garantindo que cada linha de código seja um ativo estratégico.',
      cardTitle: 'Arquitetura de Elite',
      cardSubtitle: 'Liderando a visão técnica da Kairo'
    },
    standardOfWork: {
      badge: 'Nossa Identidade',
      title: 'Construindo o futuro',
      titleHighlight: 'com propósito',
      desc: 'Na Kairo, combinamos inovação tecnológica com acompanhamento humano para gerar valor real e confiança.'
    },
    history: {
      title: "A História da Kairo",
      desc: "Nascemos em Barranquilla com a convicção de que a tecnologia deve ser uma aliada para os negócios.",
      badge: "Nossa Origem"
    },
    mission: {
      title: "Missão",
      desc: "Impulsionamos as empresas da Colômbia a crescer com soluções tecnológicas acessíveis e confiáveis.",
      badge: "Missão"
    },
    vision: {
      title: "Visão",
      desc: "Ser o parceiro estratégico líder em transformação digital na América Latina.",
      badge: "Destino"
    },
    cta: {
      tooltip: 'Vamos falar sobre seu projeto? 🚀',
      button: 'Agendar Chamada',
    },
    trustSignals: {
      metrics: [
        { value: '+20', label: 'Sistemas Liderados', sublabel: 'Em indústrias críticas' },
        { value: 'Alta', label: 'Disponibilidade', sublabel: 'Sistemas de alta escala' },
        { value: 'Hospedagem', label: 'Estratégica', sublabel: 'Sabemos o que você precisa' },
        { value: 'Padrões', label: 'de Elite', sublabel: 'Garantia de qualidade' }
      ],
      techStackTitle: 'Stack Tecnológico & Ecossistema CMS'
    },
    footer: {
      description: 'Transformamos ideias em soluções digitais excepcionais. Desenvolvimento web profissional com tecnologias de ponta.',
      services: {
        title: 'Serviços',
        items: ['Desenvolvimento Web', 'E-commerce', 'Otimização', 'Suporte Técnico']
      },
      company: {
        title: 'Empresa',
        items: ['Nosso Processo', 'Projetos', 'Clientes', 'Contato']
      },
      contact: 'Contato',
      rights: '© 2025 Kairo. Todos os direitos reservados.',
      privacy: 'Política de Privacidade',
      terms: 'Termos de Serviço'
    },
    ourApproach: {
      badge: 'Metodologia Ágil',
      titleLine1: 'Mais que código, entregamos',
      titleLine2: 'resultados de negócio.',
      subtitle: 'Nosso processo é projetado para minimizar riscos e maximizar o retorno do seu investimento tecnológico.',
      steps: [
        {
          title: 'Estratégia de Crescimento',
          desc: 'Alinhamos sua visão de negócio com a tecnologia certa. Não apenas programamos, desenhamos o caminho para o sucesso.',
          tag: 'Foco no ROI'
        },
        {
          title: 'Engenharia Escalável',
          desc: 'Construímos com padrões da Amazon e Google. Código limpo, tempos de carregamento mínimos e segurança blindada.',
          tag: 'Alto Desempenho'
        },
        {
          title: 'Garantia de Continuidade',
          desc: 'Servidores premium e suporte prioritário. Seu site não é uma despesa, é um ativo que cuidamos 24/7.',
          tag: 'Suporte 24/7'
        }
      ]
    }
